...
####################################
WORKSPACEX_ENABLE_EMBEDDING = os.environ.get("WORKSPACEX_ENABLE_EMBEDDING", "False").lower() == "true"
...
WORKSPACEX_EMBEDDING_DIMENSIONS = os.environ.get("WORKSPACEX_EMBEDDING_DIMENSIONS", "1024")
